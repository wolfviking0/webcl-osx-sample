...
KERNEL_hello			= 	
KERNEL_transpose		= 	--preload-file transpose_kernel.cl
KERNEL_trajectories		= 	--preload-file Sources/Kernel/TrajectoriesKernel.cl
KERNEL_scan				= 	--preload-file scan_kernel.cl
KERNEL_reduce			= 	--preload-file reduce_float_kernel.cl --preload-file reduce_float2_kernel.cl --preload-file reduce_float4_kernel.cl --preload-file reduce_int_kernel.cl --preload-file reduce_int2_kernel.cl --preload-file reduce_int4_kernel.cl
KERNEL_noise			= 	--preload-file noise_kernel.cl
